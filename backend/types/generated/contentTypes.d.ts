...
export interface ApiApartmentApartment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.RichText;
    floor: Schema.Attribute.Integer & Schema.Attribute.Required;
    gallery: Schema.Attribute.Media<'images', true>;
    layout_image: Schema.Attribute.Media<'images'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    publishedAt: Schema.Attribute.DateTime;
    renovation: Schema.Attribute.Enumeration<
      ['without_repair', 'whitebox', 'full_repair']
    >;
    rooms: Schema.Attribute.Integer & Schema.Attribute.Required;
    section: Schema.Attribute.Integer & Schema.Attribute.Required;
...
export interface ApiContactContact extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    form_success_text: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'\u041C\u044B \u0441\u043A\u043E\u0440\u043E \u043F\u0435\u0440\u0435\u0437\u0432\u043E\u043D\u0438\u043C \u0432\u0430\u043C.'>;
    form_success_title: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'\u0417\u0430\u044F\u0432\u043A\u0430 \u043E\u0442\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u0430!'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::contact.contact'
    > &
      Schema.Attribute.Private;
    office_address: Schema.Attribute.String;
    office_label: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'\u041E\u0444\u0438\u0441 \u043F\u0440\u043E\u0434\u0430\u0436'>;
    ...
    title: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'\u041E\u0441\u0442\u0430\u043B\u0438\u0441\u044C \u0432\u043E\u043F\u0440\u043E\u0441\u044B?'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    developer_link: Schema.Attribute.String;
    ...
    publishedAt: Schema.Attribute.DateTime;
    social_text: Schema.Attribute.Text;
...
export interface ApiHeroHero extends Struct.SingleTypeSchema {
  collectionName: 'hero';
  info: {
    description: '\u0413\u043B\u0430\u0432\u043D\u044B\u0439 \u044D\u043A\u0440\u0430\u043D \u0441\u0430\u0439\u0442\u0430';
  ...
  attributes: {
    ...
    button1_text: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'\u0412\u044B\u0431\u0440\u0430\u0442\u044C \u043A\u0432\u0430\u0440\u0442\u0438\u0440\u0443'>;
    button2_link: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'/#projects'>;
    button2_text: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'\u041E \u043F\u0440\u043E\u0435\u043A\u0442\u0430\u0445'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    ...
    subtitle: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'\u0421\u0442\u0440\u043E\u0438\u0442\u0435\u043B\u044C\u043D\u0430\u044F \u043A\u043E\u043C\u043F\u0430\u043D\u0438\u044F'>;
...
export interface ApiNewsitemNewsitem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    preview_text: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPartnerpostPartnerpost extends Struct.CollectionTypeSchema {
  collectionName: 'partner_posts';
  info: {
    description: '';
    displayName: 'Partner Post';
    pluralName: 'partnerposts';
    singularName: 'partnerpost';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiSitesettingsSitesettings extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    default_address: Schema.Attribute.String;
    default_email: Schema.Attribute.Email;
    default_phone: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::sitesettings.sitesettings'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::newsitem.newsitem': ApiNewsitemNewsitem;
      'api::partnerpost.partnerpost': ApiPartnerpostPartnerpost;
      'api::project.project': ApiProjectProject;
      'api::sitesettings.sitesettings': ApiSitesettingsSitesettings;
